...
public class Lotto611_1 {
	...
	public static void main(String[] args) {
		...
		while(bool) {
			...
			if (!(duplCheck(myNum, bool))) { // 중복 없는 경우에만 실행
				bool = false; 				// 재반복하지 않도록 false
				generatorNum(lottoNum); 	 // 로또 번호 생성기
	...
	public static boolean duplCheck(int[] myNum, boolean bool) {
